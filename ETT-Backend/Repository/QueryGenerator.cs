    ...
    public static class QueryGenerator
    {
        public static string GetEmployee(string employeeEmail)
        {
            return "SELECT e.employee_number, e.first_name, e.last_name, "
                  + "em.yearly_billable_target_hours, em.current_billable_hours, em.target_training_hours, em.current_training_hours, em.total_yearly_pto, em.overflow_pto, em.used_pto, billable_target_to_date "
